...
add_action('init', 'tm_register_tasks_post_type');

function tm_register_tasks_post_type()
{
    $labels = array(
        'name' => __('Tasks'),
...
add_action('init', 'tm_register_progress_taxonomy');

function tm_register_progress_taxonomy()
{
    $labels = array(
        'name' => __('Progress'),
