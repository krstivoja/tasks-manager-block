  ...
  return (
    <div
      ...
      style={{
        ...
        paddingLeft: this.props.paddingSize["left"],
        paddingRight: this.props.paddingSize["right"],
        paddingBottom: this.props.paddingSize["bottom"],
      }}
    >
      {terms.map((term) => (
          ...
          {tasksByGroup[term.id] && tasksByGroup[term.id].length > 0 ? (
            <div
              ...
              style={{
                ...
                gap: this.props.sgapSize,
                paddingTop: this.props.spaddingSize["top"],
                paddingLeft: this.props.spaddingSize["left"],
                paddingRight: this.props.spaddingSize["right"],
                paddingBottom: this.props.spaddingSize["bottom"],
              }}
            >
              {tasksByGroup[term.id].map((task) => (
                ...
                >
                  ...
                  <div
                    dangerouslySetInnerHTML={{ __html: task.content.rendered }}
                  ></div>
                  <button
                    ...
                    <div className="wrap">
                      ...
                      <div className="actions">
                        {props.isAdmin && (
                          <a
                            className="edit-task"
                            href={`/wp-admin/post.php?post=${task.id}&action=edit`}
                            target="_blank"
                          >
                            Edit
                          </a>
                        )}
                        <button className="close-dialog" data-id={task.id}>
                          Close
                        </button>
                      </div>
                    </div>
